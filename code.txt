@echo off
echo           RRRRRRRR    GGGGGGGG   BBBBBBBB
echo           RR     RR   gg    gg   bb    bb
echo           RR    RR    gg         bb    bb
echo           RRRRRR      gg   gg    bbbbbb   
echo           RR    RR    gg    gg   bb    bb
echo           RR     RR   gg    gg   bb    bb
echo           RR     RR   gggggggg   bbbbbbb  Tech, 
...
@echo off & title get 11 on 'unsupported' PC || Harsha@rgb 04.07.2023, Credits to AveYo
...
::# lean xp+ color macros:  %<%:af " hello "%>>%  &  %<%:cf " w\"or\"ld "%>%   for single \ / " use .%|%\  .%|%/  \"%|%\"
